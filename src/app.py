...
activities = {
    ...
    "Basketball Club": {
        "description": "Open gym, skills training, and friendly games",
    ...
    "Debate Team": {
        "description": "Prepare for tournaments and practice public speaking",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["elijah@mergington.edu", "amelia@mergington.edu"]
    },
    "Science Club": {
        "description": "Hands-on experiments, guest lectures, and fairs",
